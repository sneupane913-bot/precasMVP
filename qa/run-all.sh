...
# server at all.
STATIC=(reachable-check copy-check header-check route-check design-check ledger-check cookie-check browser-check timing-check promise-check schema-check)
