  ...
  return (
    <div className="mx-auto max-w-lg px-5 py-10">
      <div className="mb-6 text-center">
        <p className="mb-2 inline-block rounded-full bg-go-tint px-3 py-1 text-micro font-bold uppercase tracking-wide text-go-dark">
      ...
      <div className="mb-4 rounded-card border-2 border-ink bg-surface p-6">
      ...
      <div className="mb-6 rounded-card bg-go-tint p-6 ring-1 ring-go/30">
        ...
        <p className="mt-3 text-center text-micro text-go-dark">
...
export function LockedNotice({
  ...
  return (
    <div className={`rounded-card border-2 border-line bg-surface-sunk p-5 ${className}`}>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <Link
          href="/pricing"
          className="flex-1 rounded-control bg-ink px-5 py-3.5 text-center font-bold text-white"
        >
          See the packs
        </Link>
        <Link
          href="/universities"
          className="flex-1 rounded-control border-2 border-line-strong px-5 py-3.5 text-center font-semibold text-ink-soft"
        >
          Look around first
        </Link>
      </div>
